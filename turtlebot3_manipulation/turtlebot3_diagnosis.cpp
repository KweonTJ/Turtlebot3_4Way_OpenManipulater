...
Turtlebot3Diagnosis4WD::Turtlebot3Diagnosis4WD()
{
}
...
bool Turtlebot3Diagnosis4WD::init(void)
{
...
void Turtlebot3Diagnosis4WD::showLedStatus(bool isConnected)
{
...
void Turtlebot3Diagnosis4WD::updateRxTxLed(void)
{
...
void Turtlebot3Diagnosis4WD::setPowerOn(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, HIGH);
}

void Turtlebot3Diagnosis4WD::setPowerOff(void)
{
  digitalWrite(BDPIN_DXL_PWR_EN, LOW);
}

uint8_t Turtlebot3Diagnosis4WD::updateVoltageCheck(bool check_setup)
{  
...
uint8_t Turtlebot3Diagnosis4WD::getButtonPress(uint16_t time_to_press)
{

...
// {
// }
Turtlebot3MotorDriver4WD::Turtlebot3MotorDriver4WD()
: torque_(false)
{
}
...
bool Turtlebot3MotorDriver4WD::init(void)
{
...
Dynamixel2Arduino& Turtlebot3MotorDriver4WD::getDxl()
{
  return dxl;
}

bool Turtlebot3MotorDriver4WD::is_connected()
{
...
bool Turtlebot3MotorDriver4WD::set_torque(bool onoff)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::get_torque()
{
  torque_ =
...
void Turtlebot3MotorDriver4WD::close(void)
{
  // Disable Dynamixel Torque
  set_torque(false);
}

bool Turtlebot3MotorDriver4WD::read_present_position(int32_t &left_value, int32_t &right_value)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::read_present_velocity(int32_t &left_value, int32_t &right_value)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::read_present_current(int16_t &left_value, int16_t &right_value)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::read_profile_acceleration(uint32_t &left_value, uint32_t &right_value)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::write_velocity(int32_t left_value, int32_t right_value)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::write_profile_acceleration(uint32_t left_value, uint32_t right_value)
{
  bool ret = false;
...
bool Turtlebot3MotorDriver4WD::control_motors(const float wheel_separation, float linear_value, float angular_value)
{

...
#define DXL_MOTOR_ID_LEFT_REAR		1
#define DXL_MOTOR_ID_RIGHT_REAR		2
#define DXL_MOTOR_ID_LEFT_FRONT		3
#define DXL_MOTOR_ID_RIGHT_FRONT	4
...
class Turtlebot3MotorDriver4WD
{
 public:
  Turtlebot3MotorDriver4WD();
  ~Turtlebot3MotorDriver4WD();

...
OpenManipulatorDriver4WD::OpenManipulatorDriver4WD(Dynamixel2Arduino &dxl_param)
: dxl(dxl_param),
  torque_(false),
  is_init_(false),
  is_connected_(false)
...
OpenManipulatorDriver4WD::~OpenManipulatorDriver4WD()
{
  close();
}

bool OpenManipulatorDriver4WD::init(void)
{
  ...
  dxl.writeControlTableItem(ControlTableItem::HOMING_OFFSET, motor_id_[JOINT_1], 560);
  dxl.writeControlTableItem(ControlTableItem::HOMING_OFFSET, motor_id_[JOINT_2], 1080);
  dxl.writeControlTableItem(ControlTableItem::HOMING_OFFSET, motor_id_[JOINT_3], -510);
  dxl.writeControlTableItem(ControlTableItem::HOMING_OFFSET, motor_id_[JOINT_4], -100);
...
bool OpenManipulatorDriver4WD::is_connected()
{
  bool ret = true;
...
bool OpenManipulatorDriver4WD::is_ready(void)
{
  if (is_init_ == false) return false;
...
bool OpenManipulatorDriver4WD::set_torque(bool onoff)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::get_torque()
{
  bool ret = true;
...
void OpenManipulatorDriver4WD::close(void)
{
...
bool OpenManipulatorDriver4WD::read_goal_position(joint_position_info_t &position_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::read_present_position(joint_position_info_t &position_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::read_present_velocity(joint_velocity_info_t &velocity_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::read_present_current(joint_current_info_t &current_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::read_profile_acceleration(joint_accel_info_t &accel_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::read_profile_velocity(joint_accel_info_t &accel_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::read_goal_current(joint_current_info_t &current_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_goal_position_joint(joint_position_info_t &position_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_profile_acceleration_joint(joint_accel_info_t &accel_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_profile_velocity_joint(joint_accel_info_t &accel_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_goal_current_joint(joint_current_info_t &current_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_goal_position_gripper(joint_position_info_t &position_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_profile_acceleration_gripper(joint_accel_info_t &accel_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_profile_velocity_gripper(joint_accel_info_t &accel_info)
{
  bool ret = false;
...
bool OpenManipulatorDriver4WD::write_goal_current_gripper(joint_current_info_t &current_info)
{
  bool ret = false;

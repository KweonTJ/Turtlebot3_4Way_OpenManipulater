...
Turtlebot3Sensor4WD::Turtlebot3Sensor4WD()
{
}
...
bool Turtlebot3Sensor4WD::init(void)
{
  bool ret = false;
...
void Turtlebot3Sensor4WD::initIMU(void)
{
  imu_.begin();
}

void Turtlebot3Sensor4WD::updateIMU(void)
{
  imu_.update();
}

void Turtlebot3Sensor4WD::calibrationGyro()
{
  uint32_t pre_time;
  uint32_t t_time;
...
float* Turtlebot3Sensor4WD::getImuAngularVelocity(void)
{
...
float* Turtlebot3Sensor4WD::getImuLinearAcc(void)
{
...
float* Turtlebot3Sensor4WD::getImuMagnetic(void)
{
...
float* Turtlebot3Sensor4WD::getOrientation(void)
{
...
float Turtlebot3Sensor4WD::checkVoltage(void)
{
  float vol_value;
...
uint8_t Turtlebot3Sensor4WD::checkPushButton(void)
{
  return getPushButton();
}

void Turtlebot3Sensor4WD::onMelody()
{
...
void Turtlebot3Sensor4WD::makeMelody(uint8_t index)
{
...
void Turtlebot3Sensor4WD::initBumper(void)
{
  ollo_.begin(3, TOUCH_SENSOR);
  ollo_.begin(4, TOUCH_SENSOR);
}

uint8_t Turtlebot3Sensor4WD::checkPushBumper(void)
{
...
bool Turtlebot3Sensor4WD::getBumper1State()
{
  return ollo_.read(3, TOUCH_SENSOR); 
}

bool Turtlebot3Sensor4WD::getBumper2State()
{
  return ollo_.read(4, TOUCH_SENSOR);
}

void Turtlebot3Sensor4WD::initIR(void)
{
  ollo_.begin(2, IR_SENSOR);
}

float Turtlebot3Sensor4WD::getIRsensorData(void)
{
...
void Turtlebot3Sensor4WD::initSonar(void)
{
...
void Turtlebot3Sensor4WD::updateSonar(uint32_t t)
{
...
float Turtlebot3Sensor4WD::getSonarData(void)
{
  float distance = 0.0;
...
float Turtlebot3Sensor4WD::getIlluminationData(void)
{
  uint16_t light;
...
void Turtlebot3Sensor4WD::initLED(void)
{
...
void Turtlebot3Sensor4WD::setLedPattern(double linear_vel, double angular_vel)
{

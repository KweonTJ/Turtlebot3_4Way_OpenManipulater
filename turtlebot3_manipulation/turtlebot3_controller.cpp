...
Turtlebot3Controller4WD::Turtlebot3Controller4WD()
{
...
bool Turtlebot3Controller4WD::init(float max_lin_vel, float max_ang_vel, uint8_t scale_lin_vel, uint8_t scale_ang_vel)
{
...
void Turtlebot3Controller4WD::getRCdata(float *get_cmd_vel)
{
